...
/**
 * A taglet with name &quot;@operators.reference&quot; can be used in the Javadoc comments of an operator to produce a
...
public class ReferenceTaglet implements Taglet {
	...
	private static final String NAME = "operators.reference";
	 ...
	 */
	static {
		String rapidMinerHomeName = System.getProperty("operators.home"); // TODO [property]
		if (rapidMinerHomeName == null) {
			...
			System.err.println("operators.home is not set! Assuming " + rapidMinerHome);
		} else {
	...
	private static String getBibEntry(String key) {
		...
		if (!bibFile.exists()) {
			System.err.println("operators.home is not set! Cannot find RapidMinerTutorial.bib");
			return null;
		}
