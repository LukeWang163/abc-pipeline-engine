			...
			if (performLogging) {
				if (Double.isNaN(r)) {
					...
					LogService.getRoot().log(Level.WARNING,
							"base.operators.generator.SingularNumericalGenerator.nan_generated", getFunction());
				} else if (Double.isInfinite(r)) {
					performLogging = false;
					LogService.getRoot().log(Level.WARNING,
							"base.operators.generator.SingularNumericalGenerator.infinite_value_generated", getFunction());
					r = Double.NaN;
				}
			} else if (Double.isInfinite(r)) {
				r = Double.NaN;
