		...
		try {
			...
			if (Double.isInfinite(r)) {
				...
				LogService.getRoot().log(Level.WARNING,
						"base.operators.generator.BinaryNumericalGenerator.infinite_value_generated", getFunction());
			}
			if (Double.isNaN(r)) {
				// LogService.getGlobal().log(getFunction() + ": NaN generated.",
				// LogService.WARNING);
				LogService.getRoot().log(Level.WARNING, "base.operators.generator.BinaryNumericalGenerator.nan_generated",
						getFunction());
			}
