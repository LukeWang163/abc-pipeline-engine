 ...
 */
package base.operators.adaption.belt;
...
//		ConcurrencyContext context = Resources.getConcurrencyContext(port.getPorts().getOwner().getOperator());
		BackgroudOperatorConcurrencyContext context = new BackgroudOperatorConcurrencyContext(port.getPorts().getOwner().getOperator());
...
//			ConcurrencyContext context = Resources.getConcurrencyContext(port.getPorts().getOwner().getOperator());
			ConcurrencyContext context = new BackgroudOperatorConcurrencyContext(port.getPorts().getOwner().getOperator());
			return BeltConverter.convert((IOTable) data, context);
		} else {
			return data;
		}
