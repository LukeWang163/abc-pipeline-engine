...
import base.operators.parameter.UndefinedMacroError;
 ...
 * {@link MacroDefinitionOperator}. It also defines some standard macros
...
public class MacroHandler extends Observable {
	...
	static {
		...
		try {
			...
			LogService.log(LogService.getRoot(), Level.SEVERE, e, "base.operators.MacroHandler.invalid_temp_dir", "" + tmpDir, internalTemp);
			tmpDir = internalTemp;
		}
