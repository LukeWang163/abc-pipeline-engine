 ...
 */
package base.operators.search.event;
...
public interface GlobalSearchRegistryEventListener extends EventListener {
	 ...
	 */
	void searchCategoryRegistrationChanged(final base.operators.search.event.GlobalSearchRegistryEvent e, final GlobalSearchCategory category);
