...
//
//	/**
//	 * Encodes a repository path (see {@link base.operators.repository.RepositoryLocation}) for searching.
//	 * This means that {@link base.operators.repository.RepositoryLocation#REPOSITORY_PREFIX} and
//	 * {@link base.operators.repository.RepositoryLocation#SEPARATOR} will be replaced by a string and all whitespaces will be replaced by another string.
//	 *
//	 * @param path
