...
public final class GlobalSearchResult {
	 ...
	 * disabled. Use {@link base.operators.gui.search.GlobalSearchGUIUtilities#createHTMLHighlightFromString(String, String[])} to create an HTML snippet highlighting the best matches.
	 */
