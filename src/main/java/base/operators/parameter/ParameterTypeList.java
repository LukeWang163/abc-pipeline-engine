 ...
 * {@link Operator#getParameterList(String)}. Please note that in principle
...
public class ParameterTypeList extends CombinedParameterType {
	...
	public void getDefinitionToXML(Element typeElement, Document doc) {
		Element keyTypeElement = XMLTools.addTag(typeElement, ELEMENT_KEY_TYPE);
		XMLExporter.par2XML(keyTypeElement, keyType, doc);

		Element valueTypeElement = XMLTools.addTag(typeElement, ELEMENT_VALUE_TYPE);
		XMLExporter.par2XML(valueTypeElement, valueType, doc);
