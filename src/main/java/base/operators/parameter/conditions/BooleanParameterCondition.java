...
//	}
	...
	//为输出参数修改
	@Override
	public void getDefinitionAsXML(Element conditionElement) {
		conditionElement.setAttribute("type", "boolean");
		conditionElement.setAttribute("description", "BooleanParameterCondition");
		Element valuesElement = XMLTools.addTag(conditionElement, "Values");
		Element valueElement = XMLTools.addTag(valuesElement, "Value");
		valueElement.setAttribute("value", String.valueOf(getConditionValue()));
		//valuesElement.appendChild(valueElement);
		//conditionElement.appendChild(valuesElement);
	}
}
