...
public class EqualTypeCondition extends ParameterCondition {
	...
	public void getDefinitionAsXML(Element element) {
		...
		for (String value : possibleOptions) {
			Element possibleOptionElement = XMLTools.addTag(possibleOptionsElement, ELEMENT_POSSIBLE_OPTION);
			possibleOptionElement.setAttribute("value", value);
			XMLTools.addTag(possibleOptionsElement, ELEMENT_POSSIBLE_OPTION);
		}

		Element fulfillingOptionsElement = XMLTools.addTag(element, ELEMENT_FULFILLING_OPTIONS);
		for (int value : fulfillingOptions) {
			Element fulfillingOptionElement = XMLTools.addTag(fulfillingOptionsElement, ELEMENT_FULFILLING_OPTION);
			fulfillingOptionElement.setAttribute("value", String.valueOf(value));
		}
