...
public class ProcessLayoutXMLFilter implements ProcessXMLFilter {
	...
	private static final String KEY_OPERATOR_RECTANGLE = "base.operators.io.process.operator_rectangle";
	private static final String KEY_PORT_SPACING = "base.operators.io.process.port_spacing";
	public static final String KEY_OPERATOR_CHAIN_POSITION = "base.operators.io.process.operator_chain_position";
	public static final String KEY_OPERATOR_CHAIN_ZOOM = "base.operators.io.process.operator_chain_zoom";
	private static final String KEY_SCROLL_POSITION = "base.operators.io.process.scroll_position";
	private static final String KEY_SCROLL_INDEX = "base.operators.io.process.scroll_index";
	private static final String KEY_RESTORE = "base.operators.io.process.restore";
