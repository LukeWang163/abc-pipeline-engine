...
import base.operators.io.process.conditions.ParameterEqualsCondition;
import base.operators.operator.Operator;
import base.operators.io.process.conditions.ParameterUnequalsCondition;
import base.operators.io.process.conditions.ParseRuleCondition;
			...
			if (conditionNode instanceof Element) {
				...
				if (conditionElem.getTagName().equals("parameter_equals")) {
					...
					LogService.getRoot().log(Level.WARNING,
							"base.operators.io.process.rules.AbstractConditionedParseRule.unknown_condition",
