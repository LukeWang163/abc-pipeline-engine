...
import base.operators.operator.IOMultiplier;
import base.operators.operator.IOMultiplyOperator;
								...
								LogService
										...
										.log(Level.WARNING,
												I18N.getMessage(
														...
														"base.operators.io.process.rules.ReplaceIOMultiplierRule.creating_iomultiplier2_error",
														e), e);
