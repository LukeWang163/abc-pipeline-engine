 ...
 */
package base.operators.security;
...
import base.operators.operator.ScriptingOperator;
...
import base.operators.license.StudioLicenseConstants;
import base.operators.security.internal.InternalPluginClassLoader;
...
public final class PluginSandboxPolicy extends Policy {
	...
	public static final String RAPIDMINER_INTERNAL_PERMISSION = "accessClassInPackage.operators.internal";
	 ...
	 * SNAPSHOT versions
	 */
	private static final String PROPERTY_SECURITY_ENFORCED = "base.operators.security.enforce";
