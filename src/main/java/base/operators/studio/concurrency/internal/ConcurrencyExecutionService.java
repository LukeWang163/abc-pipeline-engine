...
public interface ConcurrencyExecutionService {
	...
	/**
	 * Can be used to set an overriding {@link base.operators.core.concurrency.ConcurrencyContext} to the {@link
	 * ProcessRootOperator}. This is then used instead of the regular {@link
	 * StudioConcurrencyContext}. <p/> Internal API, do not use!
	 */
	String OVERRIDING_CONTEXT = "base.operators.core.concurrency.OverridingConcurrencyContext";
...
//		return Math.max(2_000, threadSetting);
	 ...
	 * {@link }, that will capture all the side effects. If
