...
*/
package base.operators.studio.io.data.internal.file.excel;

import java.nio.file.Path;

import base.operators.studio.io.data.internal.ResultSetAdapter;
import base.operators.studio.io.data.internal.ResultSetAdapterUtils;
import base.operators.core.io.data.DataSet;
import base.operators.core.io.data.DataSetException;
import base.operators.core.io.data.DataSetMetaData;
import base.operators.core.io.data.source.DataSource;
import base.operators.core.io.data.source.DataSourceConfiguration;
import base.operators.core.io.data.source.DataSourceFeature;
import base.operators.core.io.data.source.FileDataSource;
import base.operators.operator.OperatorException;
import base.operators.operator.nio.ExcelDateTimeTypeGuesser;
import base.operators.operator.nio.model.DataResultSet;
import base.operators.operator.nio.model.DateFormatProvider;
import base.operators.operator.nio.model.ExcelResultSetConfiguration;
import base.operators.operator.nio.model.xlsx.XlsxResultSet.XlsxReadMode;
import base.operators.operator.nio.model.xlsx.XlsxSheetMetaDataParser;
import base.operators.operator.nio.model.xlsx.XlsxUtilities.XlsxCellCoordinates;
