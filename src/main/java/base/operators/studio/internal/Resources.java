...
public class Resources {
	...
	public static final String CONTEXT_KEY = "base.operators.core.concurrency.ContextUserData";
	 ...
	 */
	public static class ContextUserData implements UserData<Object> {

		private final ConcurrencyContext context;

		public ContextUserData(ConcurrencyContext context) {
