 ...
 */
package base.operators.settings;
...
public enum Telemetry implements ParameterChangeListener {
	 ...
	 */
	ACCOUNT("operators.studio.deny.account", false),
	ALL_TELEMETRY("operators.studio.deny.allcommunication", false),
	CTA("operators.studio.deny.cta", false),
	MARKETPLACE("operators.studio.deny.marketplace", false),
	NEWS("operators.studio.deny.news", false),
	USAGESTATS("operators.studio.deny.usagestats", false),
	WISDOM_OF_CROWDS("operators.studio.deny.woc", false),
	EDUCATION("operators.studio.deny.education", false);
