...
/**
 * A very basic and simple implementation of the {@link Attributes} interface
 * based on a linked list of {@link AttributeRole}s and simply delivers the
 * same {@link AttributeRoleIterator} which might skip either regular or
 * special attributes.
 *
