...
*/
package base.operators.example.table;
 ...
 * 
 * @see base.operators.tools.jdbc.DatabaseHandler
 * @see base.operators.operator.io.DatabaseDataReader
 * @see base.operators.operator.io.KDBExampleSource
			...
			case DONT_KNOW_YET:
				try {
					...
					LogService
							.getRoot()
							.log(Level.SEVERE,
									"base.operators.example.table.ResultSetDataRowReader.error_while_reading_examples_from_result_set",
									e.getMessage());
					return false;
				}
			default:
