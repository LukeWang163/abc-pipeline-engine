...
final class IntegerAutoColumn implements Column {
	...
	static abstract class IntegerAutoChunk implements Serializable {
		...
		IntegerAutoChunk(int id, IntegerAutoChunk[] chunks, ExampleSetBuilder.DataManagement management) {
			this.id = id;
			this.chunks = chunks;
	 ...
	 */
	IntegerAutoColumn(int size, ExampleSetBuilder.DataManagement management) {
		this.management = management;
		ensure(size);
	}
