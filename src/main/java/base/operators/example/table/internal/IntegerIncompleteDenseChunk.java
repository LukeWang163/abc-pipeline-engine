...
import base.operators.example.table.internal.IntegerIncompleteAutoColumn.IntegerIncompleteChunk;
...
final class IntegerIncompleteDenseChunk extends IntegerIncompleteChunk {
	...
	IntegerIncompleteDenseChunk(int id, IntegerIncompleteChunk[] chunks, int size, ExampleSetBuilder.DataManagement management) {
