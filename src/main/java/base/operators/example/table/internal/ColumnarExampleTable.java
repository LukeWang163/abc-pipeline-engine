...
import base.operators.example.table.AbstractExampleTable;
...
public class ColumnarExampleTable extends AbstractExampleTable implements GrowingExampleTable {
	...
	private ExampleSetBuilder.DataManagement management = ExampleSetBuilder.DataManagement.AUTO;
	...
	public ColumnarExampleTable(List<Attribute> attributes) {
		this(attributes, ExampleSetBuilder.DataManagement.AUTO, false);
	}
	 ...
	 */
	public ColumnarExampleTable(List<Attribute> attributes, ExampleSetBuilder.DataManagement management, boolean completable) {
		super(attributes);
	...
	private void updateColumn(final int column, Attribute attribute) {
		...
		switch (attribute.getValueType()) {
			...
			case Ontology.POLYNOMINAL:
				if (management == ExampleSetBuilder.DataManagement.SPEED_OPTIMIZED) {
