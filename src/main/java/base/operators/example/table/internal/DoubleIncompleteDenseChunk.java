...
/**
 * Dense {@link DoubleIncompleteAutoColumn.DoubleIncompleteAutoChunk} for double value data of a
 * {@link DoubleIncompleteAutoColumn}.
 *
 * @author Gisa Schaefer
 * @since 7.3.1
 */
final class DoubleIncompleteDenseChunk extends DoubleIncompleteAutoColumn.DoubleIncompleteAutoChunk {
	...
	DoubleIncompleteDenseChunk(int id, DoubleIncompleteAutoColumn.DoubleIncompleteAutoChunk[] chunks, int size, ExampleSetBuilder.DataManagement management) {
		this(id, chunks, size, false, management);
	}

	DoubleIncompleteDenseChunk(int id, DoubleIncompleteAutoColumn.DoubleIncompleteAutoChunk[] chunks, int size, boolean stayDense,
                               ExampleSetBuilder.DataManagement management) {
	...
	private void checkSparse() {
		...
		if (result.density < thresholdDensity) {
			...
			DoubleIncompleteAutoColumn.DoubleIncompleteAutoChunk sparse = new DoubleIncompleteSparseChunk(id, chunks, defaultValue, management);
