...
/**
 * Sparse {@link DoubleAutoColumn.DoubleAutoChunk} for double value data used in a {@link DoubleAutoColumn}.
 *
 * @author Gisa Schaefer
 * @since 7.3.1
 */
final class DoubleAutoSparseChunk extends DoubleAutoColumn.DoubleAutoChunk {
	...
	DoubleAutoSparseChunk(DoubleAutoColumn.DoubleAutoChunk[] chunks, int id, double defaultValue, ExampleSetBuilder.DataManagement management) {
	...
	private void changeToDense(int max) {
		DoubleAutoColumn.DoubleAutoChunk dense = new DoubleAutoDenseChunk(chunks, id, ensuredSize, management);
