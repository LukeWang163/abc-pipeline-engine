...
//import base.operators.operator.execution.FlowCleaner;
import base.operators.operator.similarity.ExampleSet2SimilarityExampleSet;
...
import base.operators.operator.WrapperOperatorRuntimeException;
...
public class SimilarityExampleSet extends AbstractExampleSet {
	 ...
	 * {@link FlowCleaner} calls. Will throw a {@link UserError}
	 * for all other calls.
	 *
	 * @author Jan Czogalla
	 * @since 8.2
