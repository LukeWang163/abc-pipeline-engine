 ...
 */
package base.operators.example.set;
...
public class CorrectPredictionCondition implements Condition {
	...
	public CorrectPredictionCondition(ExampleSet exampleSet, String parameterString) throws ConditionCreationException {
		...
		if (missingLabel && missingPrediction) {
			throw new ConditionCreationException(I18N.getErrorMessage("base.operators.example.set.CorrectPredictionCondition.missing_label_and_prediction"));
		}
		if (missingLabel) {
			throw new ConditionCreationException(I18N.getErrorMessage("base.operators.example.set.CorrectPredictionCondition.missing_label"));
		}
		if (missingPrediction) {
			throw new ConditionCreationException(I18N.getErrorMessage("base.operators.example.set.CorrectPredictionCondition.missing_prediction"));
		}
	}
