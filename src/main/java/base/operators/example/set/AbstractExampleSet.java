...
import base.operators.datatable.DataTableExampleSetAdapter;
...
public abstract class AbstractExampleSet extends ResultObjectAdapter implements ExampleSet {
	 ...
	 * ExampleTable} and the set's attributes might be unsafe to be read from concurrently
	 * and thus need to be checked separately.
	 *
	 * <p>A complete check is implemented by
	 * {@link ExampleSets#createThreadSafeCopy(ExampleSet)} which only creates a deep copy
	 ...
	 * @see ExampleSets#createThreadSafeCopy(ExampleSet)
	 */
