...
public class WrongPredictionCondition implements Condition {
	...
	public WrongPredictionCondition(ExampleSet exampleSet, String parameterString) throws ConditionCreationException {
		...
		if (missingLabel && missingPrediction) {
			throw new ConditionCreationException(I18N.getErrorMessage("base.operators.example.set.WrongPredictionCondition.missing_label_and_prediction"));
		}
		if (missingLabel) {
			throw new ConditionCreationException(I18N.getErrorMessage("base.operators.example.set.WrongPredictionCondition.missing_label"));
		}
		if (missingPrediction) {
			throw new ConditionCreationException(I18N.getErrorMessage("base.operators.example.set.WrongPredictionCondition.missing_prediction"));
		}
	}
