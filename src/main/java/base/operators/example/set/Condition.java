 ...
 * {@link ConditionedExampleSet}s, a special sub class of
 * {@link ExampleSet} that skips all examples that do not fulfill this
 * condition. In order for the
 * {@link ConditionedExampleSet#createCondition(String, ExampleSet, String)}
