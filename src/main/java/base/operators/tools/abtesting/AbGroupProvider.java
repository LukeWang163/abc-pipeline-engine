 ...
 * </dl>
 * The selected group should stay the same as long as the {@linkplain base.operators.license.LicenseUser#getEmail() license user email address} does not change.
 * <p>
