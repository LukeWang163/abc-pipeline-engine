...
*/
package base.operators.tools.expression.internal.function.eval;

import base.operators.tools.expression.Constant;
import base.operators.tools.expression.ExpressionType;
import base.operators.tools.expression.internal.SimpleConstant;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;
import java.util.Map;
//import base.operators.gui.properties.ExpressionPropertyDialog;
