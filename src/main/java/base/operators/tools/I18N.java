...
public class I18N {
	...
	static {
		...
		if (!locale.getLanguage().isEmpty()) {
			...
			LogService.getRoot().log(Level.INFO, "base.operators.tools.I18N.set_locale_to", locale);
		} else {
			locale = Locale.getDefault();
			LogService.getRoot().log(Level.INFO, "base.operators.tools.I18N.using_default_locale", locale);
		}
		JComponent.setDefaultLocale(locale);

		USER_ERROR_BUNDLE = new ExtensibleResourceBundle(ResourceBundle.getBundle(
				"base.operators.resources.i18n.UserErrorMessages", locale, I18N.class.getClassLoader()));
		ERROR_BUNDLE = new ExtensibleResourceBundle(ResourceBundle.getBundle("base.operators.resources.i18n.Errors", locale,
				I18N.class.getClassLoader()));
		GUI_BUNDLE = new ExtensibleResourceBundle(ResourceBundle.getBundle("base.operators.resources.i18n.GUI", locale,
				I18N.class.getClassLoader()));
		SETTINGS_BUNDLE = new ExtensibleResourceBundle(ResourceBundle.getBundle("base.operators.resources.i18n.Settings",
				locale, I18N.class.getClassLoader()));

		ResourceBundle plotterBundle = ResourceBundle.getBundle("base.operators.resources.i18n.PlotterMessages", locale,
				I18N.class.getClassLoader());
	...
	public static String getMessage(ResourceBundle bundle, String key, Object... arguments) {
		try {
			...
			LogService.getRoot().log(Level.FINEST, "base.operators.tools.I18N.missing_key", key);
			return key;
		}
	}
	...
	public static void registerLanguage(String languageTag) {
		...
		if (Locale.forLanguageTag(languageTag).getLanguage().isEmpty()) {
			LogService.getRoot().log(Level.INFO, "base.operators.tools.I18N.add_language_wrong_format", String.valueOf(languageTag));
		...
		if (!(type instanceof ParameterTypeCategory)) {
			LogService.getRoot().log(Level.SEVERE, "base.operators.tools.I18N.add_language_failed", languageTag);
			return;
		}
