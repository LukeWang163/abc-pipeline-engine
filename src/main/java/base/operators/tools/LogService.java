...
public class LogService extends WrapperLoggingHandler {
	...
	private static final Logger GLOBAL_LOGGER = Logger.getLogger("base.operators",
			"base.operators.resources.i18n.LogMessages");
	...
	private LogService(Logger logger) {
		...
		if (RapidMiner.getExecutionMode().canAccessFilesystem()) {
			try {
				...
				LogService.getRoot().log(Level.WARNING, "base.operators.logservice.logfile.failed_to_init", e.getMessage());
			}
		}
	}
