...
import base.operators.tools.cipher.KeyGeneratorTool;
import base.operators.tools.config.actions.ConfigurableAction;
...
//				.getAbstractConfigurator(getTypeId());
		AbstractConfigurator<? extends Configurable> configurator = null;
			...
			if (type.getKey().equals(key)) {
				...
				try {
					...
					LogService.getRoot().log(Level.WARNING,
							"base.operators.tools.config.AbstractConfigurable.cannot_backup_key");
				}
