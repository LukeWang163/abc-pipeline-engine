...
import base.operators.tools.usagestats.ActionStatisticsCollector.Key;
...
enum CtaEventAggregator {
	...
	private static final boolean NOT_IN_UI_MODE = !RapidMiner.getExecutionMode().equals(RapidMiner.ExecutionMode.UI);
