...
*/
package base.operators.tools.documentation;
...
import base.operators.tools.XMLParserException;
...
public class XMLOperatorDocBundle extends OperatorDocBundle {
	...
	private static class XMLControl extends Control {
		...
		public ResourceBundle newBundle(String baseName, Locale locale, String format, ClassLoader loader, boolean reload)
			...
			LogService.getRoot().log(Level.FINE,
					"base.operators.tools.documentation.XMLOperatorDocBundle.looking_up_operator_documentation",
			...
			if (format.equals("xml")) {
				...
				if (url != null) {
					...
					LogService.getRoot().log(Level.CONFIG,
							"base.operators.tools.documentation.XMLOperatorDocBundle.loading_operator_documentation", url);
					try {
						...
						LogService
								...
								.log(Level.WARNING,
										I18N.getMessage(
												...
												"XMLOperatorDocBundle.exception_creating_operatordocbundle",
												e), e);
	...
	public XMLOperatorDocBundle(URL url, String resourceName) throws IOException {
		...
		try {
			...
			LogService.getRoot().log(
					...
					I18N.getMessage(LogService.getRoot().getResourceBundle(),
							"base.operators.tools.documentation.XMLOperatorDocBundle.creating_xml_parser_error", e), e);
		...
		for (int i = 0; i < helpElements.getLength(); i++) {
			...
			try {
				...
				if (operatorKey == null) {
					...
					LogService.getRoot().log(Level.FINE,
							"base.operators.tools.documentation.XMLOperatorDocBundle.missing_operator_help", operatorKey);
				}
				...
				LogService.getRoot().log(
						Level.WARNING,
						I18N.getMessage(LogService.getRoot().getResourceBundle(),
								"base.operators.tools.documentation.XMLOperatorDocBundle.malformed_operator_documentation",
								e), e);
		...
		// " groups.");
		LogService.getRoot().log(Level.FINE, "base.operators.tools.documentation.XMLOperatorDocBundle.loaded_documentation",
