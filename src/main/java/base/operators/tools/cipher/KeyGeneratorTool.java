...
public class KeyGeneratorTool {
	...
	public static void createAndStoreKey() throws KeyGenerationException {
		...
		if (!RapidMiner.getExecutionMode().canAccessFilesystem()) {
			LogService.getRoot().log(Level.CONFIG, "base.operators.tools.cipher.KeyGeneratorTool.skip_key_generation",
			...
			try {
				...
				LogService.getRoot().log(
						...
						I18N.getMessage(LogService.getRoot().getResourceBundle(),
								"base.operators.tools.cipher.KeyGeneratorTool.generating_key_error", e), e);
				writeException = e;
			}
