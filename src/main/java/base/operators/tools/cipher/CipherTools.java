...
public class CipherTools {
	...
	public static void main(String[] args) throws Exception {
		...
		try (FileInputStream fis = new FileInputStream(keyFile); ObjectInputStream in = new ObjectInputStream(fis)) {
			...
			int actualLength = in.read(bytes);
		}
...
//			}
//
//			key = KeyGeneratorTool.makeKey(rawKey);
...
//	}
		...
		byte[] encryptData = cipher.doFinal("123456".getBytes(Charset.forName("UTF-8")));
		System.out.println(encryptData);
		String base64 = Base64.encodeBytes(encryptData);
