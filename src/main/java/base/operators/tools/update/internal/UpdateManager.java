...
public interface UpdateManager {
	...
	public static final String PARAMETER_UPDATE_INCREMENTALLY = "operators.update.incremental";
	public static final String PARAMETER_UPDATE_URL = "operators.update.url";
	public static final String UPDATESERVICE_URL = "https://marketplace.operators.base/UpdateServer";
	public static final String OLD_UPDATESERVICE_URL = "http://marketplace.rapid-i.base:80/UpdateServer";
	public static final String PACKAGEID_RAPIDMINER = "operators-studio-6";
