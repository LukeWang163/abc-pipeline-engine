 ...
 */
package base.operators.tools.container;
...
public class StackingMap<K, V> implements Map<K, V> {
	...
	public StackingMap(Class<? extends Map> mapClass) {
		...
		try {
			...
			LogService.getRoot().log(Level.WARNING, "base.operators.tools.container.StackingMap.failed_map_initialization", mapClass.getName());
		}
