...
public class WebServiceTools {
	...
	public static void setTimeout(BindingProvider port, int timeout) {
		...
		ctxt.put("base.sun.xml.ws.developer.JAXWSProperties.CONNECT_TIMEOUT", timeout);
		ctxt.put("base.sun.xml.ws.connect.timeout", timeout);
		ctxt.put("base.sun.xml.ws.request.timeout", timeout);
		ctxt.put("base.sun.xml.internal.ws.connect.timeout", timeout);
		ctxt.put("base.sun.xml.internal.ws.request.timeout", timeout);
