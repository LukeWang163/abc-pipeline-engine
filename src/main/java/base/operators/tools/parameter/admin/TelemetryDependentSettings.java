 ...
 */
package base.operators.tools.parameter.admin;
...
final class TelemetryDependentSettings {
	 ...
	 */
	private static final List<String> UPDATES_SUB_KEYS = null;

	/**
	 * List of settings that don't have any effect without the recommender
	 */
	private static final List<String> RECOMMENDER_SUB_KEYS = Arrays.asList("operators.recommender.enable_recommendations_6_5", "operators.recommender.confidence", "operators.recommender.parameter.confidence", "operators.recommender.parameter.threshold", "operators.recommender.highlight.threshold", "operators.recommender.initialized_6_5");
