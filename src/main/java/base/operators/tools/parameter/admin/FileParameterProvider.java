...
class FileParameterProvider implements ParameterProvider {
	...
	private static final String ERROR_INVALID_ENCODING_LOG = "The settings file \"%s\" contains an invalid unicode character, learn more at https://docs.oracle.base/javase/8/docs/api/java/util/Properties.html";
