...
public final class ParameterEnforcer {
	 ...
	 */
	public static final String RAPIDMINER_CONFIG_REFRESH = "operators.admin_config.refetch_seconds";

	/**
	 * Reference to another config file, useful for local file based configs
	 */
	public static final String RAPIDMINER_REMOTE_CONFIG = "operators.admin_config.location";
