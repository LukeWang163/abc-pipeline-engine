...
import base.operators.tools.documentation.GroupDocumentation;
...
public class GroupTreeNode extends GroupTree {
	...
	GroupTreeNode(GroupTree parent, String key, OperatorDocBundle bundle) {
		...
		if (bundle != null) {
			...
			LogService.getRoot().log(Level.FINE, "base.operators.tools.GroupTreeNode.no_documentation_bundle_associated",
					getFullyQualifiedKey());
