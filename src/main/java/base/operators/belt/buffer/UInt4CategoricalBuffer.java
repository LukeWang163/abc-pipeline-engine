...
import base.operators.belt.column.BooleanDictionary;
import base.operators.belt.column.CategoricalColumn;
...
import base.operators.belt.util.IntegerFormats.Format;
import base.operators.belt.util.IntegerFormats.PackedIntegers;
...
import static base.operators.belt.util.IntegerFormats.readUInt4;


/**
 * Implementation of a {@link CategoricalBuffer} with category index format {@link Format#UNSIGNED_INT4} that can
 * hold {@code 15} different categories. Two category indices are stored in a single {@code byte}.
 *
 * @author Gisa Meier
 */
public class UInt4CategoricalBuffer<T> extends CategoricalBuffer<T> {
	 ...
	 */
	UInt4CategoricalBuffer(int length) {
