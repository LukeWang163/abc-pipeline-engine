 ...
 * @see #toColumn()
 */
public abstract class NumericBuffer {

	/**
	 * Error message when trying to change frozen buffer
	 */
	public static final String BUFFER_FROZEN_MESSAGE = "Buffer cannot be changed after used to create column";
	...
	public Column toColumn() {
		freeze();
		return ColumnAccessor.get().newNumericColumn(type(), getData());
	}
