...
package base.operators.belt.execution;
...
public enum Workload {
	/**
	 * Use the default configuration. By default Belt assumes a medium workload per data-point. However, it is not
	 * guaranteed to show the same behavior as {@link #MEDIUM}.
	 */
	DEFAULT,
