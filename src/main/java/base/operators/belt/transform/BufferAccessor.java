...
import base.operators.belt.buffer.Buffers.InternalBuffers;


/**
 * Provides access to selected package-private methods from the {@code base.operators.belt.buffer} package. See {@link
 * Buffers} for the initialization code. This code is in place to allow for dividing the code base into meaningful
 * sub-package without exposing sensitive methods (e.g., constructors for internal types). It is a straight-forward
 * implementation of the friend package pattern (Practical API Design, Tulach 2008).
 *
 * @author Gisa Meier
 */
