 ...
 * @author Gisa Meier
 */
final class NumericColumnReducer<T> implements Calculator<T> {
	...
	NumericColumnReducer(Column source, Supplier<T> supplier, ObjDoubleConsumer<T> reducer, BiConsumer<T, T> combiner) {
		this.source = source;
