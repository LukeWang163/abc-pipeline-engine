 ...
 * @author Gisa Meier
 */
final class ApplierNNumericToObject<T> implements Calculator<ObjectBuffer<T>> {
	...
	ApplierNNumericToObject(List<Column> sources, Function<NumericRow, T> operator) {
	 ...
	 */
	private static <T> void mapPart(final List<Column> sources, final Function<NumericRow, T> operator, final ObjectBuffer<T> target,
                                    int from, int to) {
