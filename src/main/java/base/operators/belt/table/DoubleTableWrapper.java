...
public final class DoubleTableWrapper extends RowwiseStatisticsExampleSet {
	...
	/**
	 * This creates a header example set from the table. In contrast to {@link base.operators.belt.table.BeltConverter#convertHeader(Table)}, the
	...
	static HeaderExampleSet getShiftedHeader(Table table) {
		...
		for (String label : labels) {
			...
			Attribute attribute = AttributeFactory.createAttribute(label, base.operators.belt.table.BeltConverter.getValueType(table, label, i));
