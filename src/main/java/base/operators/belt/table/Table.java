...
import base.operators.belt.column.CacheMappedColumn;
import base.operators.belt.column.Column;
import base.operators.belt.execution.Context;
import base.operators.belt.execution.ExecutionUtils;
import base.operators.belt.execution.Workload;
import base.operators.belt.function.DoubleBinaryPredicate;
import base.operators.belt.function.IntBinaryPredicate;
import base.operators.belt.reader.*;
import base.operators.belt.transform.Filterer;
import base.operators.belt.transform.RowFilterer;
import base.operators.belt.transform.RowTransformer;
import base.operators.belt.transform.Transformer;
...
public final class Table {
	 ...
	 * base.operators.belt.util.ColumnMetaData.Uniqueness#COLUMN}.
	 *
	 * @param label
	 * 		the column label
	 * @param type
