...
/**
 * A {@link NumericColumnWriter} that can change its size and contains double values.
 *
 * @author Gisa Meier
 */
final class RealColumnWriter implements NumericColumnWriter {
	...
	public Column toColumn() {
		freeze();
		return ColumnAccessor.get().newNumericColumn(Column.TypeId.REAL, data);
	}
