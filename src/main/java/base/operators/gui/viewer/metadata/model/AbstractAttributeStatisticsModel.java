...
/**
 * Abstract model for the AttributeStatisticsPanel. See implementations for details.
 *
 * @author Marco Boeck
 *
 */
public abstract class AbstractAttributeStatisticsModel {
    ...
    /**
     * Adds a AttributeStatisticsEventListener which will be informed of all changes to this
     * model.
     *
     * @param listener
     */
