...
public class ScriptingOperator extends Operator {
	...
	protected void performAdditionalChecks() {
		...
		try {
			...
			if (startIndex > -1 && endIndex > -1) {
				addError(new SimpleProcessSetupError(ProcessSetupError.Severity.WARNING, getPortOwner(), "script_has_macro"));
			}
	...
	public void doWork() throws OperatorException {
		...
		if (getParameterAsBoolean(PARAMETER_STANDARD_IMPORTS)) {
			...
			imports.append("import base.operators.example.*;\n");
			imports.append("import base.operators.example.set.*;\n");
			imports.append("import base.operators.example.table.*;\n");
			imports.append("import base.operators.operator.*;\n");
