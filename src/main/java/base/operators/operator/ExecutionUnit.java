...
import base.operators.operator.execution.UnitExecutionFactory;
import base.operators.operator.execution.UnitExecutor;
import base.operators.operator.ports.*;
import base.operators.operator.ports.metadata.CompatibilityLevel;
import base.operators.operator.ports.metadata.OperatorLoopError;
...
public class ExecutionUnit extends AbstractObservable<ExecutionUnit> {
	...
	private final base.operators.tools.Observer<Port> delegatingPortObserver = new DelegatingObserver<>(this, this);
		...
		do {
			...
			if (!(Character.isUpperCase(c) || Character.isDigit(c))) {
				...
				LogService.getRoot().log(Level.WARNING,
						"base.operators.operator.ExecutionUnit.process_name_does_not_follow_name_conventions",
