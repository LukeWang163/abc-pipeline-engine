...
import base.operators.operator.condition.InnerOperatorCondition;
...
import base.operators.operator.ports.metadata.MDTransformer;
import base.operators.operator.ports.metadata.Precondition;
import base.operators.tools.DelegatingObserver;
import base.operators.tools.ListenerTools;
...
public abstract class OperatorChain extends Operator {
	...
	public void setSubprocesses(ExecutionUnit[] subprocesses){
