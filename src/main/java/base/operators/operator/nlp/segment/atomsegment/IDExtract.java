package base.operators.operator.nlp.segment.atomsegment;
...
//		System.out.println("BankCard==="+getBankCard(s));
	...
	public static void main(String args[]){
		...
		String ss = "0531—66601130王AB1234电话号码8615953128866身份证号430528197810295353电子邮件地址jhwang@inspur.com座机0531-85105818银行卡4270300016729930，周小飞于2012-10-09购入一车，车牌号码鲁A5768N，2%，百分之一";
		Map<Integer, String> result = getPerNum(ss);
		...
		String text = "你喜欢看韩剧吗？还是你更喜欢看小说。。。。１５１５４１１０４１５　ＯＲ　ＮＯ？";
