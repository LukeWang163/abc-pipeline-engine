...
public class Main {
	...
	public void train(String[] args) throws IOException, Exception {
		...
		a.parseArgs(args);
		FastText fasttext = new FastText();
		fasttext.train(a,null);
	}

	public static void main(String[] args) {

/*		String[] args1 ={"predict-prob","F:\\TestData\\fasttext-test\\nlp_fasttext_model.bin","F:\\TestData\\fasttext-test\\data.txt","3"};
		args = args1;*/

		String[] args1 ={"supervised","-input", "d:\\Users\\zhanglsh01\\Desktop\\news_fasttext_train.txt","-output", "d:\\Users\\zhanglsh01\\Desktop\\model"};
		args = args1;
