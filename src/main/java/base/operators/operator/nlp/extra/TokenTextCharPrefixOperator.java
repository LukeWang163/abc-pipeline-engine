...
public class TokenTextCharPrefixOperator extends Operator {
    ...
    public TokenTextCharPrefixOperator(OperatorDescription description){
        super(description);
    ...
    public void doWork() throws OperatorException {
        ...
        int prefix_length = getParameterAsInt(PREFIX_LENGTH);
        ...
        for (int i = 0; i < exampleSet.size(); i++) {
            ...
            if (word.length() > prefix_length)
                example.setValue(prefix_attribute, prefix_attribute.getMapping().mapString(prefix + word.substring (0, prefix_length)));
        }
    ...
    public List<ParameterType> getParameterTypes() {
        ...
        types.add(new ParameterTypeInt(PREFIX_LENGTH,"The length of word prefixes.", 1, Integer.MAX_VALUE, 2, false));
