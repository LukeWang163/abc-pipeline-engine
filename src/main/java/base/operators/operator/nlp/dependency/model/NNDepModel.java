...
import nlp.core.parser.process.DocumentPreprocessor;
import nlp.core.parser.tagger.maxent.MaxentTagger;
import nlp.core.parser.trees.GrammaticalStructure;

import java.io.StringReader;
import java.util.Iterator;
import java.util.List;

public class NNDepModel extends ResultObjectAdapter implements Model {
    ...
    public NNDepModel(DependencyParser parser, MaxentTagger tagger, ExampleSet trainExampleSet, String language) {
        this.parser = parser;
        this.tagger = tagger;
    ...
    public String getName() {
        return "Neural Network Parser Model";
    }
