...
*/
package base.operators.operator.performance;
...
public class PolynominalClassificationPerformanceEvaluator extends AbstractPerformanceEvaluator {
	...
	private static final Class<?>[] SIMPLE_CRITERIA_CLASSES = { AbsoluteError.class,
		RelativeError.class,
		LenientRelativeError.class,
		StrictRelativeError.class,
		NormalizedAbsoluteError.class,
		RootMeanSquaredError.class,
		RootRelativeSquaredError.class,
		SquaredError.class,
		CorrelationCriterion.class,
		SquaredCorrelationCriterion.class,
		CrossEntropy.class, Margin.class,
		SoftMarginLoss.class, LogisticLoss.class };
	...
	public List<PerformanceCriterion> getCriteria() {
		...
		for (int i = 0; i < SIMPLE_CRITERIA_CLASSES.length; i++) {
			try {
				...
				.getRoot()
				.log(Level.SEVERE,
						"base.operators.operator.performance.PolynominalClassificationPerformanceEvaluator.instantiating_simple_criteria_classes_error",
