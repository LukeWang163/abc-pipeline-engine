...
import base.operators.operator.nio.model.DataResultSet.ValueType;
import base.operators.operator.nio.model.ParsingError.ErrorCode;
...
public class DataResultSetTranslator {
	...
	private double getOrParseDate(DataResultSetTranslationConfiguration config, DataResultSet dataResultSet, int row,
		...
		} catch (base.operators.operator.nio.model.ParseException e1) {
	...
	private double getDate(DataResultSet dataResultSet, int row, int column, boolean isFaultTolerant)
		...
		} catch (base.operators.operator.nio.model.ParseException e) {
