...
import base.operators.operator.nio.file.WriteFileOperator;
...
public abstract class AbstractDataResultSetReader extends AbstractExampleSource {
	 ...
	 * these options is chosen is determined by the parameter {@link WriteFileOperator#PARAMETER_DESTINATION_TYPE}.
	 */
