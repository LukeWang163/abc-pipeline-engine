...
public class AddEntryToArchiveFile extends Operator {
	...
	public void doWork() throws OperatorException {
		...
		ArchiveFileObject.FuzzyCompressionLevel compressionLevel = null;
		if (overrideCompressionLevel) {
			switch (getParameterAsInt(PARAMETER_COMPRESSION_LEVEL)) {
				case COMPRESSION_LEVEL_BEST:
					compressionLevel = ArchiveFileObject.FuzzyCompressionLevel.BEST;
					break;
				case COMPRESSION_LEVEL_FASTEST:
					compressionLevel = ArchiveFileObject.FuzzyCompressionLevel.FASTEST;
					break;
				case COMPRESSION_LEVEL_NONE:
					compressionLevel = ArchiveFileObject.FuzzyCompressionLevel.NONE;
					break;
				case COMPRESSION_LEVEL_DEFAULT:
				default:
					compressionLevel = ArchiveFileObject.FuzzyCompressionLevel.DEFAULT;
					break;
			}
