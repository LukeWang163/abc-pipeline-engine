...
*/
package base.operators.operator.nio.file.compression;
		...
		if (!getParameterAsBoolean(PARAMETER_USE_DEFAULT_COMPRESSION_LEVEL)) {
			switch (getParameterAsInt(PARAMETER_COMPRESSION_LEVEL)) {
				case COMPRESSION_LEVEL_BEST:
					archiveFileObject.setCompressionLevel(ArchiveFileObject.FuzzyCompressionLevel.BEST);
					break;
				case COMPRESSION_LEVEL_FASTEST:
					archiveFileObject.setCompressionLevel(ArchiveFileObject.FuzzyCompressionLevel.FASTEST);
					break;
				case COMPRESSION_LEVEL_NONE:
					archiveFileObject.setCompressionLevel(ArchiveFileObject.FuzzyCompressionLevel.NONE);
					break;
				case COMPRESSION_LEVEL_DEFAULT:
				default:
					archiveFileObject.setCompressionLevel(ArchiveFileObject.FuzzyCompressionLevel.DEFAULT);
					break;
			}
		}
