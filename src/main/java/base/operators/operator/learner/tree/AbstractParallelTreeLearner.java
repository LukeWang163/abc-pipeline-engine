...
import base.operators.operator.learner.tree.criterions.AbstractColumnCriterion;
import base.operators.operator.learner.tree.criterions.AccuracyColumnCriterion;
import base.operators.operator.learner.tree.criterions.ColumnCriterion;
import base.operators.operator.learner.tree.criterions.GainRatioColumnCriterion;
import base.operators.operator.learner.tree.criterions.GiniIndexColumnCriterion;
import base.operators.operator.learner.tree.criterions.InfoGainColumnCriterion;
import base.operators.operator.learner.tree.criterions.LeastSquareColumnCriterion;
		...
		private void makeError(int valueType) {
			...
			switch (valueType) {
				case Ontology.NOMINAL:
					...
					createError(ProcessSetupError.Severity.WARNING, qfixes, "tree_input.least_square_nominal",
							CRITERIA_NAMES[CRITERION_LEAST_SQUARE]);
					break;
				case Ontology.NUMERICAL:
					qfixes.add(new ParameterSettingQuickFix(operator, PARAMETER_CRITERION,
							CRITERIA_NAMES[CRITERION_LEAST_SQUARE]));
					createError(ProcessSetupError.Severity.WARNING, qfixes, "tree_input.least_square_numerical",
							CRITERIA_NAMES[CRITERION_LEAST_SQUARE]);
					break;
				default:
					break;
