...
import base.operators.operator.io.ExampleSource;
import base.operators.operator.learner.associations.BooleanAttributeItem;
 ...
 * description file (.aml) for the {@link ExampleSource ExampleSource}
