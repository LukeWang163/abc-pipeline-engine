...
public abstract class KernelModel extends PredictionModel {
	 ...
	 *             {@link #KernelModel(ExampleSet, ExampleSetUtilities.SetsCompareOption, ExampleSetUtilities.TypesCompareOption)}
	...
	public KernelModel(ExampleSet exampleSet, ExampleSetUtilities.SetsCompareOption sizeCompareOperator,
		...
		this.attributeConstructions = base.operators.example.Tools.getRegularAttributeConstructions(exampleSet);
	}
	...
	public String toString() {
		String[] attributeNames = base.operators.example.Tools.getRegularAttributeNames(getTrainingHeader());
