...
*/
package base.operators.operator.learner.functions.kernel.jmysvm.examples;
...
public class SVMExamples implements Serializable {
	 ...
	 */
	public SVMExamples(ExampleSet exampleSet, Attribute labelAttribute,
		...
		while (reader.hasNext()) {
			...
			for (Attribute attribute : regularAttributes) {
				...
				if (!base.operators.example.Tools.isDefault(attribute.getDefault(), value)) {
