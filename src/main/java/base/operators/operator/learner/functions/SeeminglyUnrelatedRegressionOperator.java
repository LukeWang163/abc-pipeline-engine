...
import static base.operators.operator.learner.functions.linear.LinearRegression.M5_PRIME;
import static base.operators.operator.learner.functions.linear.LinearRegression.PARAMETER_ELIMINATE_COLINEAR_FEATURES;
import static base.operators.operator.learner.functions.linear.LinearRegression.PARAMETER_FEATURE_SELECTION;
import static base.operators.operator.learner.functions.linear.LinearRegression.PARAMETER_MIN_TOLERANCE;
import static base.operators.operator.learner.functions.linear.LinearRegression.PARAMETER_RIDGE;
import static base.operators.operator.learner.functions.linear.LinearRegression.PARAMETER_USE_BIAS;
import static base.operators.operator.learner.functions.linear.LinearRegression.SELECTION_METHODS;
...
import base.operators.operator.learner.functions.linear.LinearRegression;
import base.operators.operator.learner.functions.linear.LinearRegressionMethod;
