...
*/
package base.operators.operator.learner.functions.kernel.jmysvm.svm;

import base.operators.example.Attribute;
import base.operators.example.Example;
import base.operators.example.ExampleSet;
import base.operators.operator.Operator;
import base.operators.operator.learner.functions.kernel.AbstractMySVMLearner;
import base.operators.operator.learner.functions.kernel.JMySVMLearner;
import base.operators.operator.learner.functions.kernel.jmysvm.examples.SVMExample;
...
import base.operators.operator.learner.functions.kernel.jmysvm.optimizer.QuadraticProblem;
import base.operators.parameter.UndefinedParameterError;
import base.operators.tools.LogService;
import base.operators.tools.RandomGenerator;
import base.operators.tools.WrapperLoggingHandler;
import base.operators.operator.learner.functions.kernel.jmysvm.optimizer.QuadraticProblemSMO;
import base.operators.operator.learner.functions.kernel.jmysvm.util.MaxHeap;
import base.operators.operator.learner.functions.kernel.jmysvm.util.MinHeap;
...
public abstract class SVM implements SVMInterface {
	...
	public SVM(Operator paramOperator, Kernel new_kernel, SVMExamples new_examples,
               ExampleSet rapidMinerExamples, RandomGenerator randomGenerator)
		...
		if (weightAttribute != null) {
			Iterator<Example> reader = rapidMinerExamples.iterator();
			int index = 0;
