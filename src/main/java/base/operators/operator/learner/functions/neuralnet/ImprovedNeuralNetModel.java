...
*/
package base.operators.operator.learner.functions.neuralnet;
...
public class ImprovedNeuralNetModel extends PredictionModel {
	...
	protected ImprovedNeuralNetModel(ExampleSet trainingExampleSet) {
		...
		this.attributeNames = base.operators.example.Tools.getRegularAttributeNames(trainingExampleSet);
	}
