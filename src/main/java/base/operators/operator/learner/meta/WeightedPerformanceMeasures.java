		...
		while (reader.hasNext()) {
			...
			if ((ePred >= 0 && ePred < this.predictions.length) && (eLabel >= 0 && eLabel < this.labels.length)) {
				...
				LogService
						.getRoot()
						.log(Level.WARNING,
								"base.operators.operator.learner.meta.WeightedPerformanceMeasures.deleted_example_with_illega_label",
			...
			for (int j = 0; j < matrix[i].length; j++) {
				...
				if (Double.isNaN(predLabelJi) || predLabelJi < 0 || predLabelJi > 1) {
					...
					LogService.getRoot().log(Level.WARNING,
							"base.operators.operator.learner.meta.WeightedPerformanceMeasures.found_illegal_value");
				}
	...
	public static double reweightExamples(ExampleSet exampleSet, ContingencyMatrix cm, boolean allowMarginalSkews)
		...
		while (reader.hasNext()) {
			...
			if (Double.isNaN(lift) || lift < 0) {
				...
				LogService.getRoot().log(Level.WARNING,
						"base.operators.operator.learner.meta.WeightedPerformanceMeasures.applied_rule_with_illegal_lift",
						lift);
				...
				if (Double.isNaN(weight) || Double.isInfinite(weight) || weight < 0) {
					...
					// LogService.WARNING);
					LogService.getRoot().log(Level.WARNING,
							"base.operators.operator.learner.meta.WeightedPerformanceMeasures.found_illegal_weight", weight);
					...
					if (prec <= 0 || invPrec < 0 || Double.isInfinite(beta) || Double.isNaN(beta)) {
						...
						LogService
								.getRoot()
								.log(Level.WARNING,
										"base.operators.operator.learner.meta.WeightedPerformanceMeasures.reweighting_uses_invalid_value",
