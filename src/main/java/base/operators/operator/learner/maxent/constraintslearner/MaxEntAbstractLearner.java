 ...
 */
package base.operators.operator.learner.maxent.constraintslearner;
...
import static base.operators.example.Tools.*;
 ...
 *
 */
public abstract class MaxEntAbstractLearner extends Operator implements MaxEntLearner {

    private final InputPort exampleSetInput = getInputPorts().createPort("training set");
    private final InputPort constraintsFileInput = getInputPorts().createPort("constraints file");
    ...
    public MaxEntAbstractLearner(OperatorDescription description) {
        super(description);
    ...
    public void doWork() throws OperatorException {
        ...
        SimpleFileObject simpleFileObject = constraintsFileInput.getData(SimpleFileObject.class);
        // some checks
        isLabelled(exampleSet);
        isNonEmpty(exampleSet);
        hasRegularAttributes(exampleSet);
        ...
        Model model = learn(exampleSet, simpleFileObject);
