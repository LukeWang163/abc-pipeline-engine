...
import base.operators.tools.GroupTree;
...
public class OperatorDescription implements Comparable<OperatorDescription> {
	...
	private static final ImageIcon UNSUPPORTED_ICON_SMALL = null;

	/** the icon for the constraint violation operators */
	private static final ImageIcon UNSUPPORTED_ICON = null;

	/** the large icon for the constraint violation operators */
	private static final ImageIcon UNSUPPORTED_ICON_LARGE = null;
...
//		setIconName(XMLTools.getTagContents(element, "icon"));
	...
	public String getAbbreviatedClassName() {
		return getOperatorClass().getName().replace("base.operators.operator.", "c.r.o.");
	}
