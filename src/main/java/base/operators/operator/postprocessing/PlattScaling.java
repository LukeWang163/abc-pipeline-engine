...
*/
package base.operators.operator.postprocessing;
...
import base.operators.operator.ports.metadata.ModelApplicationRule;
	...
	public static double getLogOddsPosConfidence(double originalConfidence) {
		...
		if (Double.isNaN(confidence)) { // error, just try to continue
			...
			LogService.getRoot().log(Level.WARNING,
					"base.operators.operator.postprocessing.PlattScaling.found_a_nan_confidence_during_platts_scaling");
		}
