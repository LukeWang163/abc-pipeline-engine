...
public class DiscretizationModel extends PreprocessingModel {
		...
		for (double rangeValue : entry) {
			...
			switch (rangeNameType) {
				case RANGE_NAME_LONG:
					usedRangeName = rangeBaseName + i + " [" + base.operators.tools.Tools.formatIntegerIfPossible(lastLimit) + " - "
							+ base.operators.tools.Tools.formatIntegerIfPossible(rangeValue) + "]";
					break;
				case RANGE_NAME_SHORT:
					usedRangeName = rangeBaseName + i;
					break;
				case RANGE_NAME_INTERVAL:
					usedRangeName = "[" + base.operators.tools.Tools.formatNumber(lastLimit, numberOfDigits) + " - "
							+ base.operators.tools.Tools.formatNumber(rangeValue, numberOfDigits) + "]";
					break;
			}
	...
	public String toString() {
		...
		for (String attributeName : rangesMap.keySet()) {
			buffer.append(base.operators.tools.Tools.getLineSeparator());
			buffer.append(base.operators.tools.Tools.getLineSeparator());
