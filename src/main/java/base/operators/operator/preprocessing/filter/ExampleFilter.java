...
import base.operators.example.set.CustomFilter;
import base.operators.example.set.ExpressionFilter;
...
import base.operators.operator.tools.ExpressionEvaluationException;
import base.operators.parameter.ParameterType;
import base.operators.parameter.ParameterTypeBoolean;
import base.operators.parameter.ParameterTypeExpression;
import base.operators.parameter.ParameterTypeFilter;
 ...
 *
 * <p>
 * By specifying an implementation of {@link Condition} and a parameter
	...
	public ExampleSet apply(final ExampleSet inputSet) throws OperatorException {
		...
		try {
			if (className.equals(ConditionedExampleSet.KNOWN_CONDITION_NAMES[ConditionedExampleSet.CONDITION_CUSTOM_FILTER])) {
				...
				//修改为null 20190821 不获取macro
				condition = new CustomFilter(inputSet, operatorFilterList,
						getParameterAsBoolean(PARAMETER_FILTERS_LOGIC_AND), null);
