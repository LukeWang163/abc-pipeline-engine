...
public class NominalToNumeric extends PreprocessingOperator {
	 ...
	 *
	 * @see base.operators.operator.preprocessing.filter.NominalToNumericModel
	 * @author Marius Helf
	 */
	@Deprecated
	public static class NominalToNumericModel extends base.operators.operator.preprocessing.filter.NominalToNumericModel {
		...
		private Object readResolve() {
			return new base.operators.operator.preprocessing.filter.NominalToNumericModel(getTrainingHeader(),
					INTEGERS_CODING);
		}
	}
	...
	public PreprocessingModel createPreprocessingModel(ExampleSet exampleSet) throws OperatorException {
		...
		int codingType = getParameterAsInt(PARAMETER_CODING_TYPE);
		if (codingType == INTEGERS_CODING) {
			return new base.operators.operator.preprocessing.filter.NominalToNumericModel(exampleSet, codingType);
	...
	public Class<? extends PreprocessingModel> getPreprocessingModelClass() {
		return base.operators.operator.preprocessing.filter.NominalToNumericModel.class;
	}
