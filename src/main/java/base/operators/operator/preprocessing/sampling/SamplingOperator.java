...
import base.operators.operator.preprocessing.sampling.sequences.AbsoluteSamplingSequenceGenerator;
import base.operators.operator.preprocessing.sampling.sequences.ProbabilitySamplingSequenceGenerator;
import base.operators.operator.preprocessing.sampling.sequences.RelativeSamplingSequenceGenerator;
import base.operators.operator.preprocessing.sampling.sequences.SamplingSequenceGenerator;
		...
		if (balanceData) {
			...
			if (numberOfSubsets < numberOfIterations) {
				LogService.getRoot().log(Level.WARNING,
						"base.operators.operator.preprocessing.sampling.SamplingOperator.too_few_subsets",
