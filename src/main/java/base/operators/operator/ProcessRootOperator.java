...
import base.operators.ProcessListener;
...
import base.operators.operator.ports.SinglePortExtender;
...
public final class ProcessRootOperator extends OperatorChain {
	...
	public static final String PROPERTY_RAPIDMINER_GENERAL_RANDOMSEED = "operators.general.randomseed";
	...
	private final SinglePortExtender<InputPort> resultPortExtender = new SinglePortExtender<>("result", getSubprocess(0)
			.getInnerSinks());
	public SinglePortExtender<InputPort> getResultPortExtender(){
		return resultPortExtender;
	}
...
//				}
	...
	public List<ParameterType> getParameterTypes() {
		...
		try {
			...
			logWarning("Bad integer in property 'operators.general.randomseed', using default seed ("
	...
	public IOContainer getResults(boolean omitNullResults) {
		...
		return innerSinks.createIOContainer(true, omitNullResults);
	}
