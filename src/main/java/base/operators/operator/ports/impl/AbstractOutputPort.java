...
import base.operators.operator.ports.PortException;
 ...
 * {@link #deliver(IOObject)} method is missing.
 *
 * @author Nils Woehler
 *
 */
public abstract class AbstractOutputPort extends AbstractPort implements OutputPort {
	...
	private boolean connectForDoWork = false;

	@Override
	public void setConnectForDoWork(){
		this.connectForDoWork = true;
	}
	...
	public boolean isConnected() {
		return (connectedTo != null) || connectForDoWork;
	}
