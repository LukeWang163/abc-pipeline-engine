 ...
 */
package base.operators.operator.ports;
...
public class DeliveringPortIdentifier implements UserData<Object> {
	...
	/**
	 * Constructor to identify an internal {@link Port} of a {@link OperatorChain OperatorChain}
	 ...
	 * {@link Process#getOperator(String) Process.getOperator(String)}
	 */
	...
	/**
	 * ID of the {@link ExecutionUnit ExecutionUnit} (subprocess) if the
	 * {@link OutputPort} resides inside an {@link OperatorChain OperatorChain}
	 */
