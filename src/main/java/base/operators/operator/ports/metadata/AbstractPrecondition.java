...
public abstract class AbstractPrecondition implements Precondition {
	...
	protected void createError(ProcessSetupError.Severity severity, String i18nKey, Object... i18nArgs) {
		createError(severity, Collections.<QuickFix> emptyList(), i18nKey, i18nArgs);
	}

	protected void createError(ProcessSetupError.Severity severity, final List<? extends QuickFix> fixes, String i18nKey, Object... i18nArgs) {
