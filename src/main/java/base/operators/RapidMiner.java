...
import base.operators.license.AlreadyRegisteredException;
import base.operators.license.InvalidProductException;
...
import base.operators.operator.IOObjectMap;
...
import base.operators.security.PluginSandboxPolicy;
import base.operators.settings.Telemetry;
import base.operators.tools.*;
import base.operators.tools.I18N.SettingsType;
import base.operators.tools.plugin.Plugin;
import base.operators.tools.update.internal.MigrationManager;
...
public class RapidMiner {
	...
	public static final String RAPIDMINER_URL_PREFIX = "operators://";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_VERSION = "operators.version";

	/**
	 * Enables special features for developers: Validate process action, operator doc editor, etc.
	 */
	public static final String PROPERTY_DEVELOPER_MODE = "operators.developermode";
	 ...
	 * character.
	 */
	public static final String PROPERTY_RAPIDMINER_OPERATORS_ADDITIONAL = "operators.operators.additional";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_OBJECTS_ADDITIONAL = "operators.objects.additional";

	/**
	 * The name of the property indicating the path to an RC file (settings).
	 */
	public static final String PROPERTY_RAPIDMINER_RC_FILE = "operators.rcfile";

	/**
	 * The name of the property indicating the path to the global logging file.
	 */
	public static final String PROPERTY_RAPIDMINER_GLOBAL_LOG_FILE = "operators.global.logging.file";

	/**
	 * The name of the property indicating the path to the global logging file.
	 */
	public static final String PROPERTY_RAPIDMINER_GLOBAL_LOG_VERBOSITY = "operators.global.logging.verbosity";

	// Webstart properties
	public static final String PROPERTY_HOME_REPOSITORY_URL = "operators.homerepository.url";
	public static final String PROPERTY_HOME_REPOSITORY_USER = "operators.homerepository.user";
	public static final String PROPERTY_HOME_REPOSITORY_PASSWORD = "operators.homerepository.password";

	// --- INIT PROPERTIES ---

	/** A file path to an operator description XML file. */
	public static final String PROPERTY_RAPIDMINER_INIT_OPERATORS = "operators.init.operators";

	public static final String PROPERTY_RAPIDMINER_GENERAL_LOCALE_LANGUAGE = "operators.general.locale.language";
	private static final String[] PROPERTY_RAPIDMINER_GENERAL_LOCALE_LANGUAGE_VALUES = {Locale.ENGLISH.getLanguage()};
	/** @deprecated since 9.1 */
	@Deprecated
	public static final String PROPERTY_RAPIDMINER_GENERAL_LOCALE_COUNTRY = "operators.general.locale.country";
	/** @deprecated since 9.1 */
	@Deprecated
	public static final String PROPERTY_RAPIDMINER_GENERAL_LOCALE_VARIANT = "operators.general.locale.variant";

	/**
	 * Boolean parameter indicating if the plugins should be initialized at all.
	 */
	public static final String PROPERTY_RAPIDMINER_INIT_PLUGINS = "operators.init.plugins";

	/** A file path to the directory containing the plugin Jar files. */
	public static final String PROPERTY_RAPIDMINER_INIT_PLUGINS_LOCATION = "operators.init.plugins.location";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_FRACTIONDIGITS_NUMBERS = "operators.general.fractiondigits.numbers";

	/**
	 * The property name for &quot;The number of fraction digits of formatted percent values.&quot;
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_FRACTIONDIGITS_PERCENT = "operators.general.fractiondigits.percent";

	/**
	 * The name of the property indicating the maximum number of attributes stored for shortened
	 * meta data transformation.
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_MAX_META_DATA_ATTRIBUTES = "operators.general.md_attributes_limit";

	/**
	 * The name of the property indicating the maximum number of nominal values to store for meta
	 * data transformation.
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_MAX_NOMINAL_VALUES = "operators.general.md_nominal_values_limit";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_MAX_TEST_ROWS = "operators.general.max_rows_used_for_guessing";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_MAX_PROCESS_NESTING_DEPTH = "operators.general.max_process_execution_nesting_depth";

	/**
	 * The property name for &quot;Path to external Java editor. %f is replaced by filename and %l
	 * by the linenumber.&quot;
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_EDITOR = "operators.tools.editor";

	/**
	 * The property specifying the method to send mails. Either SMTP or sendmail.
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_MAIL_METHOD = "operators.tools.mail.method";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_MAIL_SENDER = "operators.tools.mail.sender";

	/**
	 * Property specifying the email address to which mails are sent if no email address is
	 * specified in the {@link base.operators.operator.ProcessRootOperator}.
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_MAIL_DEFAULT_RECIPIENT = "operators.tools.mail.default_recipient";

	/**
	 * The default value of the minimum time a process must run such that it sends a notification
	 * mail upon completion.
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_MAIL_DEFAULT_PROCESS_DURATION_FOR_MAIL = "operators.tools.mail.process_duration_for_mail";

	/**
	 * The property name for &quot;Path to sendmail. Used for email notifications.&quot;
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_SENDMAIL_COMMAND = "operators.tools.sendmail.command";

	/**
	 * The property name for &quot;The smtp host. Used for email notifications.&quot;
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_SMTP_HOST = "operators.tools.smtp.host";

	/**
	 * The property name for &quot;The smtp port. Used for email notifications.&quot;
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_SMTP_PORT = "operators.tools.smtp.port";

	/**
	 * The property name for the &quot;SMTP user. Used for email notifications.&quot;
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_SMTP_USER = "operators.tools.smtp.user";

	/**
	 * The property name for the &quot;SMTP pssword (is necessary). Used for email
	 * notifications.&quot;
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_SMTP_PASSWD = "operators.tools.smtp.passwd";

	/**
	 * The property specifying the security for smtp.
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_SMTP_SECURITY = "operators.tools.smtp.security";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_SMTP_AUTHENTICATION = "operators.tools.smtp.authentication";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_DB_ONLY_STANDARD_TABLES = "operators.tools.db.assist.show_only_standard_tables";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_TOOLS_DB_LOGIN_TIMEOUT = "operators.tools.db.login.timeout";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_LOGFILE_FORMAT = "operators.general.logfile.format";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_DEBUGMODE = "operators.general.debugmode";

	/** The name of the property indicating the default encoding for files. */
	public static final String PROPERTY_RAPIDMINER_GENERAL_DEFAULT_ENCODING = "operators.general.encoding";

	/**
	 * The name of the property indicating the preferred globally used time zone.
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_TIME_ZONE = "operators.general.timezone";

	/**
	 * The maximum number of working threads that should be used by the foreground process.
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_NUMBER_OF_THREADS = "operators.general.number_of_threads";

	/**
	 * The maximum number of working threads that should be used by background processes.
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_NUMBER_OF_THREADS_BACKGROUND = "operators.general.number_of_threads_background";

	/**
	 * The maximum number of working threads that should be used by processes.
	 */
	public static final String PROPERTY_RAPIDMINER_GENERAL_NUMBER_OF_PROCESSES = "operators.general.number_of_processes";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_UPDATE_BETA_FEATURES = "operators.update.beta_features.v2";

	/**
	 * The name of the property indicating whether or not additional permissions should be enabled
	 */
	public static final String PROPERTY_RAPIDMINER_UPDATE_ADDITIONAL_PERMISSIONS = "operators.init.additional_permissions";
	 ...
	 */
	public static final String PROPERTY_RAPIDMINER_SYSTEM_LEGACY_DATA_MGMT = "operators.system.legacy_data_mgmt";

	public static final String PROPERTY_RAPIDMINER_PROXY_MODE = "operators.proxy.mode";
	public static final String PROPERTY_RAPIDMINER_PROXY_EXCLUDE = "operators.proxy.exclude";
	...
	/**
	 * These settings are the JVM Params with a prepended operators.proxy
	 */
	public static final String PROPERTY_RAPIDMINER_HTTP_PROXY_HOST = "operators.proxy.http.proxyHost";
	public static final String PROPERTY_RAPIDMINER_HTTP_PROXY_PORT = "operators.proxy.http.proxyPort";
	public static final String PROPERTY_RAPIDMINER_HTTP_PROXY_NON_PROXY_HOSTS = "operators.proxy.http.nonProxyHosts";

	public static final String PROPERTY_RAPIDMINER_HTTPS_PROXY_HOST = "operators.proxy.https.proxyHost";
	public static final String PROPERTY_RAPIDMINER_HTTPS_PROXY_PORT = "operators.proxy.https.proxyPort";

	public static final String PROPERTY_RAPIDMINER_FTP_PROXY_HOST = "operators.proxy.ftp.proxyHost";
	public static final String PROPERTY_RAPIDMINER_FTP_PROXY_PORT = "operators.proxy.ftp.proxyPort";
	public static final String PROPERTY_RAPIDMINER_SOCKS_PROXY_HOST = "operators.proxy.socksProxyHost";
	public static final String PROPERTY_RAPIDMINER_SOCKS_PROXY_PORT = "operators.proxy.socksProxyPort";
	public static final String PROPERTY_RAPIDMINER_SOCKS_VERSION = "operators.proxy.socksProxyVersion";
	 ...
	 */
	public static final String RAPIDMINER_FOLLOW_HTTPS_TO_HTTP = "operators.system.network.follow_https_to_http";

	/**
	 * Set this parameter to {@code true} to allow http to https redirects
	 */
	public static final String RAPIDMINER_FOLLOW_HTTP_TO_HTTPS = "operators.system.network.follow_http_to_https";
	...
	public static Process readProcessFile(final File processFile, final ProgressListener progressListener)
			throws XMLException, IOException, InstantiationException, IllegalAccessException {
		try {
			LogService.getRoot().log(Level.FINE, "base.operators.RapidMiner.reading_process_file", processFile);
			if (!processFile.exists() || !processFile.canRead()) {
				LogService.getRoot().log(Level.SEVERE, "base.operators.RapidMiner.reading_process_definition_file_error",
						processFile);
			}
	...
	/**
	 * Initializes RapidMiner with the default {@link } and default {@link LicenseLocation}
	 ...
	 *
	 * <ul>
	 * <li>operators.init.operators (file path)</li>
	 * <li>operators.init.plugins (true or false)</li>
	 * <li>operators.init.plugins.location (directory path)</li>
	 * <li>operators.init.weka (true or false)</li>
	 * <li>operators.init.jdbc.lib (true or false)</li>
	 * <li>operators.init.jdbc.lib.location (directory path)</li>
	 * <li>operators.init.jdbc.classpath (true or false)</li>
	 * </ul>
	 */
...
//						"RapidMiner.generating_encryption_key_error", e.getMessage()), e);
//			}
//		}
...
//		RapidMiner.splashMessage("xml_serialization");
	 ...
	 * {@link}. CAUTION: This function has to be called AFTER {@link #init()}.
	 */
...
//	}
	...
	private static void performInitialSettings() {
		...
		if (lastVersionFile.exists()) {
			try (BufferedReader in = new BufferedReader(new FileReader(lastVersionFile))) {
				...
				LogService.getRoot().log(Level.WARNING, "base.operators.RapidMiner.reading_global_version_file_error", e);
			} catch (VersionNumber.VersionNumberException e) {
				LogService.getRoot().log(Level.WARNING, "base.operators.RapidMiner.parsing_global_version_file_error", e);
			}
		}
	...
	private static void writeLastVersion(final File versionFile) {
		try (FileWriter fw = new FileWriter(versionFile); PrintWriter out = new PrintWriter(fw)) {
			...
			LogService.getRoot().log(Level.WARNING, I18N.getMessage(LogService.getRoot().getResourceBundle(),
					"base.operators.RapidMiner.writing_current_version_error"), e);
		}
	}

	private static void performFirstInitialization(final VersionNumber lastVersion, final VersionNumber currentVersion) {
		if (currentVersion != null) {
			LogService.getRoot().log(Level.INFO, "base.operators.RapidMiner.performing_upgrade",
...
//	}
	...
	private static void runStartupHook(final Runnable runnable) {
		try {
			...
			LogService.getRoot().log(Level.WARNING, I18N.getMessage(LogService.getRoot().getResourceBundle(),
					"base.operators.RapidMiner.executing_startup_hook_error", e.getMessage()), e);
		}
	}
	...
	public synchronized static void quit(final ExitMode exitMode) {
		...
		for (Runnable hook : shutdownHooks) {
			try {
				...
				LogService.getRoot().log(Level.WARNING, I18N.getMessage(LogService.getRoot().getResourceBundle(),
						"base.operators.RapidMiner.executing_shotdown_hook_error", e.getMessage()), e);
			}
		}
		try {
			...
			// catching Throwable because this also accounts for things like ExceptionInInitializerErrors
			LogService.getRoot().log(Level.WARNING, I18N.getMessage(LogService.getRoot().getResourceBundle(),
					"base.operators.RapidMiner.error_during_finalization", e.getMessage()), e);
		}
		isInitiated = false;
		switch (exitMode) {
			case NORMAL:
